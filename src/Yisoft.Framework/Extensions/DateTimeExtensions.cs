...
namespace Yisoft.Framework.Extensions
{
	...
	public static class DateTimeExtensions
	{
		...
		public static TimeSpan GetDateDiffOfNow(this DateTime dateTime) => DateTime.Now - dateTime;
		...
		[DebuggerStepThrough]
		public static bool HasExceeded(this DateTime creationTime, int seconds) => DateTimeUtils.UtcNow > creationTime.AddSeconds(seconds);

		[DebuggerStepThrough]
		public static int GetLifetimeInSeconds(this DateTime creationTime) => (int) (DateTimeUtils.UtcNow - creationTime).TotalSeconds;

		[DebuggerStepThrough]
		public static bool HasExpired(this DateTime? expirationTime) => expirationTime.HasValue && expirationTime.Value.HasExpired();

		[DebuggerStepThrough]
		public static bool HasExpired(this DateTime expirationTime) => expirationTime < DateTimeUtils.UtcNow;
